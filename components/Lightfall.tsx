...
/**
 * Lightfall (React Bits) — WebGL falling light-streak background.
 * Ported to TypeScript; shaders are verbatim from the original source.
 * The `.lightfall-container` class lives in app/globals.css.
 */
    ...
    return () => {
      ...
      const callIfFn = (obj: unknown, key: string) => {
        ...
        if (target && typeof target[key] === "function") {
          (target[key] as () => void).call(target);
        }
      };
